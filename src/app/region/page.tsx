    ...
    return (
        <div className="w-full min-w-[1920px] flex flex-col items-start">
            ...
            <div className="mt-[45px] mx-auto">
                <h2 className="font-bold text-[27px] ml-[145px]">가고싶은 지역을 선택해주세요</h2>
                    ...
                    <div className="flex flex-col gap-[51px]">
                        <div className="flex items-center gap-[50px]">
                            {REGION_1.map((region, index) => (
                                <RegionBox key={index} name={region.name} name2={region.name2} img={region.img} img2={region.img2} engName={region.engName}/>
                            ))}
                        </div>
                        <div className="flex items-center gap-[50px]">
